...
public class CommitDialog extends TitleAreaDialog {
	...
	private boolean skipIfPossible = false;
	...
	public int open() {
		if (skipIfPossible) {
			...
			selectedFiles = new ArrayList<>(preselectedFiles);
	...
	/**
	 * @param fullSelectedSet
	 */
	public void setSkipIfPossible(Set<String> fullSelectedSet) {
		skipIfPossible = preselectedFiles.containsAll(fullSelectedSet);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		setTitle(MessageFormat.format(UIText.CommitDialog_Title, repoName));
