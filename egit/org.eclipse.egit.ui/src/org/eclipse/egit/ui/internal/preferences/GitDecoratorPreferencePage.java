...
public class GitDecoratorPreferencePage extends PreferencePage implements
	...
	static {
		...
		FILE_AND_FOLDER_BINDINGS.put(DecorationHelper.BINDING_AUTHOR,
				UIText.DecoratorPreferencesPage_bindingAuthor);
		FILE_AND_FOLDER_BINDINGS.put(DecorationHelper.BINDING_DATE,
				UIText.DecoratorPreferencesPage_bindingDate);
		FILE_AND_FOLDER_BINDINGS.put(DecorationHelper.BINDING_REV,
				UIText.DecoratorPreferencesPage_bindingRevNumber);
