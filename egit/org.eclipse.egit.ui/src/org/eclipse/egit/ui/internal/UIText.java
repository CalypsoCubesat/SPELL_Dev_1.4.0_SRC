...
public class UIText extends NLS {
	...
	/** */
	public static String DecoratorPreferencesPage_bindingAuthor;

	/** */
	public static String DecoratorPreferencesPage_bindingDate;

	/** */
	public static String DecoratorPreferencesPage_bindingRevNumber;
	...
	/** */
	public static String DecoratorPreferencesPage_bindingChangeSetRev;
