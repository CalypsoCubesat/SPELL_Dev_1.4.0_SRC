 ...
 * </p>
 * <ul>
 *   <li>{@link lu.ses.engineering.spell.spellDatabase.impl.ListImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListImpl extends ComplexValueImpl implements List
{
  /**
  ...
  {
    return SpellDatabasePackage.Literals.LIST;
  }
  ...
  public EList<DatabaseValue> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<DatabaseValue>(DatabaseValue.class, this, SpellDatabasePackage.LIST__VALUES);
    }
    return values;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SpellDatabasePackage.LIST__VALUES:
