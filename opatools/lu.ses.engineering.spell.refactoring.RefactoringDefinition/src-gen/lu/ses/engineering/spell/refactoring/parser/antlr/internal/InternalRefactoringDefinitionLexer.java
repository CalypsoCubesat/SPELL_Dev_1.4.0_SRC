...
public class InternalRefactoringDefinitionLexer extends Lexer {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            ...
            // InternalRefactoringDefinition.g:233:9: ( ( '\\t' )+ )
            // InternalRefactoringDefinition.g:233:11: ( '\\t' )+
            {
            // InternalRefactoringDefinition.g:233:11: ( '\\t' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_NL() throws RecognitionException {
        try {
            int _type = RULE_NL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRefactoringDefinition.g:235:9: ( ( '\\r' | '\\n' )+ )
            // InternalRefactoringDefinition.g:235:11: ( '\\r' | '\\n' )+
            {
            // InternalRefactoringDefinition.g:235:11: ( '\\r' | '\\n' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_VALUE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRefactoringDefinition.g:237:12: ( (~ ( ( '\\t' | '\\r' | '\\n' ) ) )* )
            // InternalRefactoringDefinition.g:237:14: (~ ( ( '\\t' | '\\r' | '\\n' ) ) )*
            {
            // InternalRefactoringDefinition.g:237:14: (~ ( ( '\\t' | '\\r' | '\\n' ) ) )*
            loop3:
            do {
