...
public class WorkspaceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WorkspacePackage.LAYOUT: {
				...
				if (result == null) result = caseWorkspace(layout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkspacePackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkspacePackage.EDITORS: {
				Editors editors = (Editors)theEObject;
				T result = caseEditors(editors);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkspacePackage.EDITOR: {
				Editor editor = (Editor)theEObject;
				T result = caseEditor(editor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WorkspacePackage.INPUT: {
			...
			case WorkspacePackage.ESTRING_TO_LAYOUT_MAP_ENTRY: {
				@SuppressWarnings("unchecked") Map.Entry<String, Layout> eStringToLayoutMapEntry = (Map.Entry<String, Layout>)theEObject;
				T result = caseEStringToLayoutMapEntry(eStringToLayoutMapEntry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Editors</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Editors</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEditors(Editors object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EString To Layout Map Entry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EString To Layout Map Entry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEStringToLayoutMapEntry(Map.Entry<String, Layout> object) {
		return null;
	}
