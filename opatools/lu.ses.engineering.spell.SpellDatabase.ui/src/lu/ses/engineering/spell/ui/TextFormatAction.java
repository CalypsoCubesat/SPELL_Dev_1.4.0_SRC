...
public class TextFormatAction extends TextEditorAction {
		 ...
		 */
		public TextFormatAction(ResourceBundle bundle, String prefix, ITextEditor editor, int operationCode) {
		 ...
		 * @since 2.0
		 */
		public TextFormatAction(ResourceBundle bundle, String prefix, ITextEditor editor, int operationCode, boolean runsOnReadOnly) {
			super(bundle, prefix, editor);
			fOperationCode= operationCode;
		...
		public void run() {
			...
			final SpellDatabaseXtextEditor editor= (SpellDatabaseXtextEditor) getTextEditor();
			if (editor == null)
				return;
