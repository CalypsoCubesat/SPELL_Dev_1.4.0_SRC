...
public class PasswordUserInfo implements UserInfo, UIKeyboardInteractive{
	...
	public boolean promptPassword(final String message){
		...
		Display.getDefault().syncExec(new Runnable() {
			...
			@Override
			public void run() {
				InputDialog dialog = new InputDialog(Display.getDefault().getActiveShell(), "Please enter your password.", message, passwd, new IInputValidator() {
