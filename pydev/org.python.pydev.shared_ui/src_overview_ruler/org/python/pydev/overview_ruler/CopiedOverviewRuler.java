...
public class CopiedOverviewRuler implements IOverviewRuler {
    ...
    protected static final Font font = new Font(null, "Monospace", 8, SWT.None);
    protected static Color black = ColorManager.getDefault().getColor(new RGB(0, 0, 0));
    ...
    protected void doPaint1(GC gc) { //fabioz: Changed to protected
        ...
        HashSet<String> paintedSteps = new HashSet<>();
        for (Iterator iterator = fAnnotationsSortedByLayer.iterator(); iterator.hasNext();) {
            ...
            for (int t = 0; t < style.length; t++) {
                ...
                while (e.hasNext()) {
                    ...
                    if ("com.python.pydev.spell_step".equals(a.getType())) {
                        if (paintedSteps.contains(a.getText())) {
                            continue;
                        }
                        paintedSteps.add(a.getText());
                    }
                    ...
                    try {
                        ...
                        if ("com.python.pydev.spell_step".equals(a.getType())) {
                            ...
                            gc.setFont(font);
                            gc.drawText(a.getText(), r.x + r.width / 2 - 7, r.y - 5, true);
