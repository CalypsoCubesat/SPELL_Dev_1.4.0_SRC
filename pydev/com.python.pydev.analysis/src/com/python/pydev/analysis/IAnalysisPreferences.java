...
public interface IAnalysisPreferences {
    ...
    public static final int TYPE_INFORMATION = IMiscConstants.TYPE_SPELL_INFO;
    public static final int TYPE_WARNING = IMiscConstants.TYPE_SPELL_WARNING;
    public static final int TYPE_ERROR = IMiscConstants.TYPE_SPELL_ERROR;
    ...
    public static final String MSG_TO_IGNORE_TYPE_INFORMATION = "@IgnoreInformation";
    public static final String MSG_TO_IGNORE_TYPE_WARNING = "@IgnoreWarning";
    public static final String MSG_TO_IGNORE_TYPE_ERROR = "@IgnoreError";
