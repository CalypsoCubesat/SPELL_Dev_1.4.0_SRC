...
public abstract class AbstractMessage implements IMessage {
    ...
    private String getTypeStr() {
        if (messages.size() == 0) {
            ...
            messages.put(IAnalysisPreferences.TYPE_WARNING, "Warning: %s");
            messages.put(IAnalysisPreferences.TYPE_INFORMATION, "Info: %s");
            messages.put(IAnalysisPreferences.TYPE_ERROR, "Error: %s");
        }
