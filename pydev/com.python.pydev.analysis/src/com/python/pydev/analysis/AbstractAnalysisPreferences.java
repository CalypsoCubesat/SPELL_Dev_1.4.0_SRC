...
public abstract class AbstractAnalysisPreferences implements IAnalysisPreferences {
    ...
    static {
        ...
        typeToIgnoreMessage.put(TYPE_INFORMATION, MSG_TO_IGNORE_TYPE_INFORMATION);
        typeToIgnoreMessage.put(TYPE_WARNING, MSG_TO_IGNORE_TYPE_WARNING);
        typeToIgnoreMessage.put(TYPE_ERROR, MSG_TO_IGNORE_TYPE_ERROR);
    }
