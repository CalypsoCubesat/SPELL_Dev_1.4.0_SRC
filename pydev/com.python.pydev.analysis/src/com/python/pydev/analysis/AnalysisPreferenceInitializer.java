...
public class AnalysisPreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public static final int DEFAULT_SEVERITY_INFORMATION = IMarker.SEVERITY_INFO; //Currently does not run by default!

    public static final String WARNING = "WARNING";
    public static final int DEFAULT_SEVERITY_WARNING = IMarker.SEVERITY_WARNING; //Currently does not run by default!

    public static final String ERROR = "ERROR";
    public static final int DEFAULT_SEVERITY_ERROR = IMarker.SEVERITY_ERROR; //Currently does not run by default!
