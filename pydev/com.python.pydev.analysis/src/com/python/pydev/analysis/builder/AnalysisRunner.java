...
public class AnalysisRunner {
    ...
    public ArrayList<MarkerInfo> generateMarkers(IDocument document, IMessage[] messages, IProgressMonitor monitor) {
        ...
        for (IMessage m : messages) {
            ...
            String quickFix = m.getQuickFix();
            if (quickFix != null && !quickFix.isEmpty()) {
                additionalInfo.put(IIssue.QUICK_FIX_ID, quickFix);
            }
            // Enable delete action for marker but disable direct editing
            additionalInfo.put(IMarker.USER_EDITABLE, null);
