...
public abstract class AbstractPydevPrefs extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    public static final String DEBUG_SPELL_REMOTE_PORT = "DEBUG_SPELL_REMOTE_PORT";
    public static final int DEFAULT_DEBUG_SPELL_REMOTE_PORT = 20000
            + (Math.abs(System.getProperty("user.name").hashCode()) % 45534);
