...
public class PyDebugHover extends AbstractPyEditorTextHover {
    ...
    public String getHoverInfo(final ITextViewer textViewer, IRegion hoverRegion) {
        ...
        if (context != null) {
            ...
            IValue value;
            try {
                EvalExpressionAction.waitForExpressionEvaluation(watchExpression, 10000);
                value = watchExpression.getValue();
            } catch (Exception ex) {
                final String expr = act;
                value = new IValue() {
                    ...
                    public String getValueString() throws DebugException {
                        // TODO Auto-generated method stub
                        return "Timeout while evaluating " + expr;
                    }
