...
public interface Constants {
    ...
    static final String ID_PYTHON_REMOTE_LAUNCH_CONFIGURATION_TYPE = "org.python.pydev.debug.remoteLaunchConfigurationType";
    ...
    static final String ATTR_REMOTE_SERVER = PLUGIN_ID + ".ATTR_REMOTE_SERVER";
    static final String ATTR_REMOTE_USER = PLUGIN_ID + ".ATTR_REMOTE_USER";
    static final String ATTR_REMOTE_PORT = PLUGIN_ID + ".ATTR_REMOTE_PORT";
    static final String ATTR_REMOTE_MISSION = PLUGIN_ID + ".ATTR_REMOTE_MISSION";
    static final String ATTR_REMOTE_SELECTED_ENTRY = PLUGIN_ID + ".ATTR_REMOTE_SELECTED_ENTRY";
    static final String ATTR_REMOTE_JSON_DB = PLUGIN_ID + ".ATTR_REMOTE_JSON_DB";
