...
public final class PydevConsoleConstants {
    ...
    public static final String DEFAULT_INITIAL_INTERPRETER_CMDS = "import sys; print('%s %s' % (sys.executable or sys.platform, sys.version));from spelldebugger.spellwrapper import *\n"
            + "import os\n";
